...
describe('getNewPosition', () => {
  ...
  it('stay still', () => {
    equal(world.getNewPosition(2,0), 2);
  });
  it('goes UP', () => {
    equal(world.getNewPosition(5,1), 2);
  });
  it('goes LEFT', () => {
    equal(world.getNewPosition(2,2), 1);
  });
  it('goes DOWN', () => {
    equal(world.getNewPosition(2,3), 5);
  });
  it('goes RIGHT', () => {
    equal(world.getNewPosition(1,4), 2);
  });
  it('blocked UP', () => {
    equal(world.getNewPosition(0,1), 0);
  });
  it('blocked LEFT', () => {
    equal(world.getNewPosition(0,2), 0);
  });
  it('blocked DOWN', () => {
    equal(world.getNewPosition(11,3), 11);
  });
  it('blocked RIGHT', () => {
    equal(world.getNewPosition(2,4), 2);
  });
});
